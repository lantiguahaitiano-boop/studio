      ...
      <main className="flex-1">
        <div className="container py-12 md:py-24 lg:py-32">
          <div className="prose prose-invert mx-auto max-w-4xl">
            ...
            <p>Al acceder y utilizar Skillico (el "Servicio"), usted acepta estar sujeto a estos Términos de Servicio ("Términos"). Si no está de acuerdo con alguna parte de los términos, no podrá acceder al Servicio.</p>

            <h2>2. Descripción del Servicio</h2>
            <p>Skillico es una plataforma de asistencia educativa que utiliza inteligencia artificial para proporcionar diversas herramientas a los estudiantes. Las características incluyen, entre otras, asistente de tareas, resumen de textos, explicador de conceptos y más.</p>
