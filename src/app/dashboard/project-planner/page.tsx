  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">Estructura y planifica tus trabajos de investigación.</p>
      </div>
      <Card className="flex min-h-[400px] flex-col items-center justify-center border-2 border-dashed">
        <div className="flex flex-col items-center text-center">
            ...
            <p className="text-muted-foreground">Estamos trabajando para traerte el Planificador de Proyectos. ¡Vuelve pronto!</p>
        </div>
      </Card>
    </div>
  );
