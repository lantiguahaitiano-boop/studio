  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">Organiza y visualiza tus ideas de forma creativa y efectiva.</p>
      </div>
      <Card className="flex min-h-[400px] flex-col items-center justify-center border-2 border-dashed">
        <div className="flex flex-col items-center text-center">
            ...
            <p className="text-muted-foreground">Estamos creando una increíble herramienta de mapas mentales. ¡Vuelve pronto!</p>
        </div>
      </Card>
    </div>
  );
